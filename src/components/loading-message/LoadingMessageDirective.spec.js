...
describe("LoadingMessageDirective", function() {
  var template = "<loadingMessage></loadingMessage>";
  var scope;
  var compile;
  var element;
  var backend;
  ...
  beforeEach(inject(function($rootScope, $compile, $httpBackend) {
    ...
    $httpBackend.expectGET('lang_en.json');
    $httpBackend.flush();
    $httpBackend.expectGET("components/loading-message/loading.html").respond("<div></div>");
  }));
